...
from common.control_protocol import IPAllocationRequest, IPAllocationResponse, RouteAdvertisement, ControlProtocol
...
class NetworkAccessEndpoint:
    ...
    def health_check_loop(self):
        ...
        retry_interval = 5.0  # 接口 UP 时，最多每 5s 尝试一次重连
